...
public class OORChaincode extends ChaincodeBase {

    private static Log _logger = LogFactory.getLog(OORChaincode.class);

    @Override
    public Response init(ChaincodeStub stub) {
        try {
            _logger.info("Init OOR Chaincode");
    ...
    public Response invoke(ChaincodeStub stub) {
        try {
            _logger.info("Invoke OOR Chaincode");
            String func = stub.getFunction();
